        ...
        private async static Task SeedExpenses(int userId, IExpenseRepository repository)
        {
            List<Expense> expenses = new List<Expense>()
            {
                ...
                new Expense() { OwnerId = userId, Title="13 expense",
                    Date=new DateTime(2020, 4, 12), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="13 expense",
                    Date=new DateTime(2020, 4, 13), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="14 expense",
                    Date=new DateTime(2020, 4, 14), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="15 expense",
                    Date=new DateTime(2020, 5, 12), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="16 expense",
                    Date=new DateTime(2020, 5, 13), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="17 expense",
                    Date=new DateTime(2020, 5, 14), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="18 expense",
                    Date=new DateTime(2020, 6, 13), Money=100, PurseId=2, TopicId = 4 },
                new Expense() { OwnerId = userId, Title="19 expense",
                    Date=new DateTime(2020, 6, 14), Money=100, PurseId=2, TopicId = 4 },
